...
/*                      All Rights Reserved                                 */
/* C10_FIR      - FINITE IMPULSE RESPONSE FILTER                            */
/* To compile:  cl6x -qko3 c10_fir.c fir10.sa a10_fir.asm -z -l lnk.cmd     */
/*                   -l rts6201.lib -o c10_fir.out                          */
/****************************************************************************/
#include <stdio.h>
#include <time.h>
...
int main()
{
    ...
    /************************************************************************/ 
    printf("FIR1 Assembly Clock Cycles:           %d\n", t_asm - t_stub);
    printf("FIR1 Assembly Optimizer Clock Cycles: %d\n", t_sa  - t_stub);
}
