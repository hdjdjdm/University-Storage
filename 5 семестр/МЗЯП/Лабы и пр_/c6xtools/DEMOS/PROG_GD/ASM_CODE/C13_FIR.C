...
/*                  All Rights Reserved                                     */
/* C13_FIR - FINITE IMPULSE RESPONSE FILTER                                 */
/* To compile:  cl6x -qko3 c13_fir.c fir13.sa a13_fir.asm -z -l lnk.cmd     */
/*                   -l rts6201.lib -o c13_fir.out                          */
/****************************************************************************/
#include <stdio.h>
#include <time.h>
...
int main()
{
    ...
    /************************************************************************/ 
    printf("FIR4 Assembly Clock Cycles:           %d\n", t_asm - t_stub);
    printf("FIR4 Assembly Optimizer Clock Cycles: %d\n", t_sa  - t_stub);
}
...
/****************************************************************************/
/* COMPUTE THE ELAPSED TIME OF THE ASSEMBLY OPTIMZER ROUTINE                */
/****************************************************************************/
clock_t time_sa(int *i)
{
    clock_t t_start, t_stop;
