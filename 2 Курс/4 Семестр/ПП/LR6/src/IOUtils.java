...
//    }
    ...
    public static MassiveInterface unmodifiableMassiveInterface(MassiveInterface o) {
        return new UnmodifiableMassive(o);
    }

    private static MassiveInterfaceFactory<?> factory = new MassiveFactory();

    public static void setMassiveIntefaceFactory(MassiveInterfaceFactory<?> newFactory) {
        factory = newFactory;
    }

    public static <T> T createInstance(int size) {
        return (T) factory.createInstance(size);
    }
}
